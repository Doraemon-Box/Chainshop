package com.snow.chainshop.module.system.service.social;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import com.snow.chainshop.framework.common.util.http.HttpUtils;
import com.snow.chainshop.framework.social.core.ChainshopAuthRequestFactory;
...
import com.snow.chainshop.module.system.dal.dataobject.social.SocialUserBindDO;
import com.snow.chainshop.module.system.dal.dataobject.social.SocialUserDO;
import com.snow.chainshop.module.system.dal.mysql.social.SocialUserBindMapper;
import com.snow.chainshop.module.system.dal.mysql.social.SocialUserMapper;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 ChainshopAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private ChainshopAuthRequestFactory chainshopAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = chainshopAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
