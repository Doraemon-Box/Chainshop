...
import com.snow.chainshop.framework.datapermission.core.util.DataPermissionUtils;
...
import com.snow.chainshop.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:chainshopyuanma}")
