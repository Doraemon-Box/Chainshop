package com.snow.chainshop.module.system.service.tenant;

import com.snow.chainshop.framework.common.enums.CommonStatusEnum;
import com.snow.chainshop.framework.common.pojo.PageResult;
import com.snow.chainshop.framework.tenant.config.TenantProperties;
...
import com.snow.chainshop.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import com.snow.chainshop.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.snow.chainshop.module.system.controller.admin.tenant.vo.tenant.TenantUpdateReqVO;
import com.snow.chainshop.module.system.dal.dataobject.permission.MenuDO;
...
import com.snow.chainshop.module.system.dal.mysql.tenant.TenantMapper;
import com.snow.chainshop.module.system.enums.permission.RoleCodeEnum;
import com.snow.chainshop.module.system.enums.permission.RoleTypeEnum;
import com.snow.chainshop.module.system.service.permission.MenuService;
import com.snow.chainshop.module.system.service.permission.PermissionService;
import com.snow.chainshop.module.system.service.permission.RoleService;
import com.snow.chainshop.module.system.service.tenant.handler.TenantInfoHandler;
import com.snow.chainshop.module.system.service.tenant.handler.TenantMenuHandler;
import com.snow.chainshop.module.system.service.user.AdminUserService;
...
import static com.snow.chainshop.framework.common.util.collection.SetUtils.asSet;
import static com.snow.chainshop.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.snow.chainshop.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static com.snow.chainshop.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.snow.chainshop.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("Chainshop", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("Chainshop"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("Chainshop");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
