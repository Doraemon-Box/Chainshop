package com.snow.chainshop.module.system.service.mail;
...
import com.snow.chainshop.module.system.controller.admin.mail.vo.template.MailTemplateCreateReqVO;
import com.snow.chainshop.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.snow.chainshop.module.system.controller.admin.mail.vo.template.MailTemplateUpdateReqVO;
import com.snow.chainshop.module.system.dal.dataobject.mail.MailTemplateDO;
import com.snow.chainshop.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.snow.chainshop.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("Chainshop")));
        // 测试 code 不匹配
