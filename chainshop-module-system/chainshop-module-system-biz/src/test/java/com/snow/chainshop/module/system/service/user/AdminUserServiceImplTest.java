package com.snow.chainshop.module.system.service.user;
...
import com.snow.chainshop.framework.common.util.collection.ArrayUtils;
...
import com.snow.chainshop.module.infra.api.file.FileApi;
...
import com.snow.chainshop.module.system.dal.dataobject.dept.UserPostDO;
...
import com.snow.chainshop.module.system.dal.mysql.dept.UserPostMapper;
import com.snow.chainshop.module.system.dal.mysql.user.AdminUserMapper;
import com.snow.chainshop.module.system.enums.common.SexEnum;
import com.snow.chainshop.module.system.service.dept.DeptService;
...
import com.snow.chainshop.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("chainshopyuanma");
        ...
        assertEquals("chainshopyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("chainshopyuanma"))).thenReturn("java");
