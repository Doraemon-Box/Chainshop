...
import com.snow.chainshop.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.snow.chainshop.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.snow.chainshop.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.snow.chainshop.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("chainshop-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("chainshop-test");
