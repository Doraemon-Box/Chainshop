package com.snow.chainshop.module.infra.service.codegen.inner;
...
import com.snow.chainshop.framework.common.exception.util.ServiceExceptionUtil;
...
import com.snow.chainshop.framework.excel.core.util.ExcelUtils;
...
import com.snow.chainshop.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.snow.chainshop.module.infra.enums.codegen.CodegenSceneEnum;
import com.snow.chainshop.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "chainshop-module-${table.moduleName}/" + // 顶级模块
                "chainshop-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "chainshop-module-${table.moduleName}/" + // 顶级模块
                "chainshop-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "chainshop-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "chainshop-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
