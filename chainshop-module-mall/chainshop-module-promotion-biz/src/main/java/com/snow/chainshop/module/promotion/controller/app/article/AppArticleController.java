package com.snow.chainshop.module.promotion.controller.app.article;

import com.snow.chainshop.framework.common.pojo.CommonResult;
import com.snow.chainshop.framework.common.pojo.PageResult;
import com.snow.chainshop.module.promotion.controller.app.article.vo.article.AppArticlePageReqVO;
import com.snow.chainshop.module.promotion.controller.app.article.vo.article.AppArticleRespVO;
...
public class AppArticleController {
    ...
    public CommonResult<List<AppArticleRespVO>> getArticleList(@RequestParam(value = "recommendHot", required = false) Boolean recommendHot,
        ...
        for (int i = 0; i < 10; i++) {
            ...
            appArticleRespVO.setTitle("Chainshop - " + i + "模块");
            appArticleRespVO.setAuthor("Chainshop");
    ...
    public CommonResult<AppArticleRespVO> getArticlePage(@RequestParam("id") Long id) {
        ...
        appArticleRespVO.setTitle("Chainshop - " + 0 + "模块");
        appArticleRespVO.setAuthor("Chainshop");
        appArticleRespVO.setCategoryId((long) random.nextInt(10000));
