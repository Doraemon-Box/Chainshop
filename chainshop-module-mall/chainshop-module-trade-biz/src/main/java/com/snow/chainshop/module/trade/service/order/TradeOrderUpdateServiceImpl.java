package com.snow.chainshop.module.trade.service.order;
...
import com.snow.chainshop.framework.common.core.KeyValue;
import com.snow.chainshop.framework.common.enums.TerminalEnum;
...
import com.snow.chainshop.module.member.api.address.AddressApi;
import com.snow.chainshop.module.member.api.address.dto.AddressRespDTO;
import com.snow.chainshop.module.member.api.level.MemberLevelApi;
import com.snow.chainshop.module.member.api.point.MemberPointApi;
...
import com.snow.chainshop.module.pay.api.order.PayOrderApi;
import com.snow.chainshop.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.snow.chainshop.module.pay.api.order.dto.PayOrderRespDTO;
import com.snow.chainshop.module.pay.enums.order.PayOrderStatusEnum;
import com.snow.chainshop.module.product.api.comment.ProductCommentApi;
import com.snow.chainshop.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.snow.chainshop.module.product.api.sku.ProductSkuApi;
import com.snow.chainshop.module.promotion.api.bargain.BargainActivityApi;
import com.snow.chainshop.module.promotion.api.bargain.BargainRecordApi;
import com.snow.chainshop.module.promotion.api.combination.CombinationRecordApi;
import com.snow.chainshop.module.promotion.api.combination.dto.CombinationRecordRespDTO;
import com.snow.chainshop.module.promotion.api.coupon.CouponApi;
import com.snow.chainshop.module.promotion.api.coupon.dto.CouponUseReqDTO;
import com.snow.chainshop.module.promotion.api.seckill.SeckillActivityApi;
import com.snow.chainshop.module.promotion.api.seckill.dto.SeckillActivityUpdateStockReqDTO;
import com.snow.chainshop.module.promotion.enums.combination.CombinationRecordStatusEnum;
import com.snow.chainshop.module.trade.controller.admin.order.vo.TradeOrderDeliveryReqVO;
import com.snow.chainshop.module.trade.controller.admin.order.vo.TradeOrderRemarkReqVO;
import com.snow.chainshop.module.trade.controller.admin.order.vo.TradeOrderUpdateAddressReqVO;
import com.snow.chainshop.module.trade.controller.admin.order.vo.TradeOrderUpdatePriceReqVO;
import com.snow.chainshop.module.trade.controller.app.order.vo.AppTradeOrderCreateReqVO;
import com.snow.chainshop.module.trade.controller.app.order.vo.AppTradeOrderSettlementReqVO;
import com.snow.chainshop.module.trade.controller.app.order.vo.AppTradeOrderSettlementRespVO;
import com.snow.chainshop.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.snow.chainshop.module.trade.convert.order.TradeOrderConvert;
import com.snow.chainshop.module.trade.dal.dataobject.cart.CartDO;
...
import com.snow.chainshop.module.trade.dal.mysql.order.TradeOrderItemMapper;
import com.snow.chainshop.module.trade.dal.mysql.order.TradeOrderMapper;
import com.snow.chainshop.module.trade.dal.redis.no.TradeOrderNoRedisDAO;
import com.snow.chainshop.module.trade.enums.ErrorCodeConstants;
import com.snow.chainshop.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import com.snow.chainshop.module.trade.enums.delivery.DeliveryTypeEnum;
import com.snow.chainshop.module.trade.enums.order.*;
import com.snow.chainshop.module.trade.framework.order.config.TradeOrderProperties;
import com.snow.chainshop.module.trade.service.brokerage.record.BrokerageRecordService;
import com.snow.chainshop.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import com.snow.chainshop.module.trade.service.message.TradeMessageService;
import com.snow.chainshop.module.trade.service.message.bo.TradeOrderMessageWhenDeliveryOrderReqBO;
import com.snow.chainshop.module.trade.service.price.TradePriceService;
...
import static com.snow.chainshop.framework.common.util.collection.CollectionUtils.*;
import static com.snow.chainshop.module.pay.enums.ErrorCodeConstants.ORDER_UPDATE_PRICE_FAIL_EQUAL;
import static com.snow.chainshop.module.pay.enums.ErrorCodeConstants.ORDER_UPDATE_PRICE_FAIL_PAID;
import static com.snow.chainshop.module.trade.enums.ErrorCodeConstants.*;
