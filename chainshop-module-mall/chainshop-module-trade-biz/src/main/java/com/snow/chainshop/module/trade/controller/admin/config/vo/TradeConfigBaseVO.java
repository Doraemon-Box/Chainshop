package com.snow.chainshop.module.trade.controller.admin.config.vo;

import com.snow.chainshop.framework.common.validation.InEnum;
import com.snow.chainshop.module.trade.enums.brokerage.BrokerageBindModeEnum;
import com.snow.chainshop.module.trade.enums.brokerage.BrokerageEnabledConditionEnum;
import com.snow.chainshop.module.trade.enums.brokerage.BrokerageWithdrawTypeEnum;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.iocoder.cn/chainshop.jpg]")
