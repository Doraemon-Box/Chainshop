...
import com.snow.chainshop.module.pay.service.channel.PayAppServiceImpl;
import com.snow.chainshop.module.pay.service.channel.PayChannelServiceImpl;
import com.snow.chainshop.module.pay.service.order.dto.PayOrderCreateReqDTO;
import com.snow.chainshop.module.pay.service.order.dto.PayOrderSubmitReqDTO;
import com.snow.chainshop.module.pay.test.BaseDbIntegrationTest;
import com.snow.chainshop.framework.common.util.date.DateUtils;
import com.snow.chainshop.framework.pay.config.ChainshopPayAutoConfiguration;
import com.snow.chainshop.framework.pay.core.enums.PayChannelEnum;
...
@Import({PayOrderServiceImpl.class, PayAppServiceImpl.class,
        PayChannelServiceImpl.class, ChainshopPayAutoConfiguration.class})
