...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.snow.chainshop";
    private static final String ARTIFACT_ID = "chainshop";
    private static final String PACKAGE_NAME = "com.snow.chainshop";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.snow.chainshop";
        String artifactIdNew = "chainshop";
        String packageNameNew = "com.snow.chainshop";
        String titleNew = "土豆管理系统";
        String projectBaseDirNew = "/Users/snow/work/ideaspace/chainshop"; // 一键改名后，“新”项目所在的目录
