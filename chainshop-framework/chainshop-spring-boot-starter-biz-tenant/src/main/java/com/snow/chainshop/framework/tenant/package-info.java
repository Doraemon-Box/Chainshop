 ...
 *      1）Spring Async：
 *          {@link com.snow.chainshop.framework.quartz.config.ChainshopAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ChainshopSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.snow.chainshop.framework.tenant;
