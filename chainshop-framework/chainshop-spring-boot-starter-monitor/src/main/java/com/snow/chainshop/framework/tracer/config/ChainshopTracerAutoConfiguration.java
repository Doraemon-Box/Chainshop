...
import com.snow.chainshop.framework.tracer.core.aop.BizTraceAspect;
import com.snow.chainshop.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "chainshop.tracer", value = "enable", matchIfMissing = true)
public class ChainshopTracerAutoConfiguration {
