package com.snow.chainshop.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.snow.chainshop.framework.common.enums.DocumentEnum;
import com.snow.chainshop.framework.mq.core.RedisMQTemplate;
import com.snow.chainshop.framework.mq.core.interceptor.RedisMessageInterceptor;
import com.snow.chainshop.framework.mq.core.pubsub.AbstractChannelMessageListener;
import com.snow.chainshop.framework.mq.core.stream.AbstractStreamMessageListener;
import com.snow.chainshop.framework.mq.job.RedisPendingMessageResendJob;
...
public class ChainshopMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "chainshop.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 chainshop.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "chainshop.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 chainshop.mq.redis.stream.enable=false 禁用多租户
