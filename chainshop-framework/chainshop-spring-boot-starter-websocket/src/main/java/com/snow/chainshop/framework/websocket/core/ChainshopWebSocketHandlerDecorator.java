package com.snow.chainshop.framework.websocket.core;
...
public class ChainshopWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public ChainshopWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
